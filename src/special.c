...
bool spec_dog_pee( CHAR_DATA *ch )
{
    ...
    case 2:
        act("$n lifts $s hind leg, and pees on $N.",ch,NULL,victim,TO_NOTVICT);
        act("$n lifts $s hind leg, and pees on you.",ch,NULL,victim,TO_VICT);
        return TRUE;
    }
...
bool spec_cast_adept( CHAR_DATA *ch )
{
    ...
    case 1:
	act( "$n utters the word 'Therin rules'.", ch, NULL, NULL, TO_ROOM );
