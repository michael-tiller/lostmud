...
#define AUTHOR	"     By Jason(jdinkel@mines.colorado.edu)\n\r" \
				...
				"     Modified for use with ROT 1.4\n\r"        \
				"     By Therin (therin2@hotmail.com)\n\r"
#define DATE	"     (Apr. 7, 1995 - ROM mod, Apr 16, 1995)\n\r" \
		"     (Port a ROM 2.4 - Nov 2, 1996)\n\r" \
		"     (Port for ROT 1.4 - Mar 20, 1999)\n\r" \
		"     Version actual : 1.81 - Sep 8, 1998\n\r"
...
DECLARE_OLC_FUN( medit_shield           );  /* ROT Therin 99 */
