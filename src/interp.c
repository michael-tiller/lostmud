...
const	struct	cmd_type	cmd_table	[] =
{
     ...
     */
    { "n",		do_north,	POS_STANDING,    0,  1,  LOG_NEVER, 0 },
    { "e",		do_east,	POS_STANDING,	 0,  1,  LOG_NEVER, 0 },
    { "s",		do_south,	POS_STANDING,	 0,  1,  LOG_NEVER, 0 },
    { "w",		do_west,	POS_STANDING,	 0,  1,  LOG_NEVER, 0 },
    { "u",		do_up,		POS_STANDING,	 0,  1,  LOG_NEVER, 0 },
    { "d",		do_down,	POS_STANDING,	 0,  1,  LOG_NEVER, 0 },
    ...
    { "run",		do_run,	POS_STANDING,	 0,  1,  LOG_NEVER, 0 },
    ...
    { "clan",		do_clanchat, POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 },
    { "clanlist",		do_clanlist, POS_RESTING,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "groups",		do_groups,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "uptime",		do_uptime,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
	...
	{ "autodamage", do_autodamage, POS_DEAD, 0, 1,LOG_NORMAL, 1 },
    ...
    { "automap",	do_automap,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
    { "map",	do_map,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "auction",	do_auction,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "war",	do_cgossip,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "music",		do_music,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "gquest",		do_gquest,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "goto",		do_goto,	POS_DEAD,	L8,  1,  LOG_NORMAL, 1 }, */
    ...
    {"autodig",   do_autodig,   POS_DEAD,     IM,  1, LOG_NORMAL, 1},
    ...
    { "vlist",		do_vlist,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "exlist",		do_exlist,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
	
	{ "saveclasses",    do_save_class, POS_DEAD,	ML,	      LOG_ALWAYS, 0 },
	{ "savegroups",    do_save_groups, POS_DEAD,	ML,	      LOG_ALWAYS, 0 },
	...
	* OLC
	*/
    { "edit",		do_olc,		POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "asave",      do_asave,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "alist",		do_alist,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "resets",		do_resets,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "redit",		do_redit,	POS_DEAD,   IM,	 1,  LOG_NORMAL, 1 },
    { "medit",		do_medit,	POS_DEAD,   IM,	 1,  LOG_NORMAL, 1 },
    { "aedit",		do_aedit,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "oedit",		do_oedit,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "mpedit",		do_mpedit,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "hedit",		do_hedit,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    { "sedit",		do_sedit,	POS_DEAD,   IM,  1,  LOG_NORMAL, 1 },
    ...
    for( clevel = LEVEL_HERO + 1; clevel < MAX_LEVEL + 1; clevel++ ) {
        for ( cmd = 0; cmd_table[cmd].name[0] != '\0'; cmd++ ) { 
            if ( (cmd_table[cmd].level >= LEVEL_HERO &&   
				 ...
				 cmd_table[cmd].show && 
				 cmd_table[cmd].level == clevel) ) {
				sprintf( buf, "[%-3d] %-12s", cmd_table[cmd].level, cmd_table[cmd].name );
				send_to_char( buf, ch );
				if ( ++col % 5 == 0 )
				send_to_char( "\n\r", ch );
			}
